...
export const defaultFaqs: FAQ[] = [
  {
    ...
    answer:
      "You can track your order from the My Orders page. The order status, delivery date, delivery slot, payment status and invoice link are available there.",
    category: "Orders",
    isActive: true,
    isFeatured: true,
    sortOrder: 1,
  ...
  },
  {
    ...
    answer:
      "Delivery depends on the selected delivery date and slot during checkout. Admin can manage delivery areas, slots and daily delivery list from the admin panel.",
    category: "Delivery",
    isActive: true,
    isFeatured: true,
    sortOrder: 2,
  ...
  },
  {
    ...
    answer:
      "After an order is delivered, you can open My Orders and submit a Return, Refund or Replacement request. Admin will review and update the request status.",
  ...
  },
  {
    ...
    answer:
      "Coupons can be applied during checkout if they are active, valid and eligible for your order value. Loyalty points are earned automatically and can also be redeemed during checkout.",
...
export function getFaqs() {
  ...
  try {
    const parsedFaqs = JSON.parse(savedFaqs) as FAQ[];
