    ...
    if (savedLoyalty) {
      try {
        ...
        if (Array.isArray(parsedLoyalty)) {
          const currentCustomer = parsedLoyalty.find(
            (customer) =>
              customer.customerEmail.trim().toLowerCase() ===
              user.email.trim().toLowerCase()
          );

          setLoyalty(currentCustomer || null);
        }
      } catch {
        setLoyalty(null);
      }
  ...
  const tierDetails = useMemo(() => {
    ...
    if (points >= 100) {
      return {
        ...
        progress: Math.round((points / 250) * 100),
      };
    }
    ...
    return {
      ...
      progress: Math.round((points / 100) * 100),
    };
  }, [loyalty?.totalPoints]);
        ...
        <section className="mx-auto max-w-md px-4 py-10">
          <div className="rounded-xl bg-white p-8 text-center shadow-sm">
            ...
            <p className="mt-2 text-gray-600">
              Please login to view your PujaFresh loyalty points.
            </p>
        ...
        <div className="flex flex-wrap items-center justify-between gap-4">
          <div>
            ...
            <p className="mt-1 text-sm text-gray-600">
              Earn points on every PujaFresh order and track your reward
              history.
            </p>
          </div>
        ...
        <div className="mt-6 rounded-2xl bg-[#7a1e13] p-6 text-white shadow-sm">
          <div className="grid gap-5 lg:grid-cols-[1fr_320px]">
              ...
              <div className="mt-5 max-w-xl">
                ...
                <div className="mt-2 h-3 overflow-hidden rounded-full bg-white/20">
                  <div
                    ...
                    style={{ width: `${tierDetails.progress}%` }}
                  />
                </div>
            ...
            <div className="rounded-xl bg-white/10 p-5">
              ...
              <p className="mt-2 text-sm text-white/80">
                Points are automatically added after successful order placement.
                Redemption can be enabled later from the admin side.
              </p>

              <Link
                href="/"
                className="mt-5 inline-block rounded bg-white px-5 py-3 text-sm font-bold text-[#7a1e13]"
              >
                Continue Shopping
              </Link>
            </div>
          ...
          <div className="flex flex-wrap items-center justify-between gap-3 border-b pb-4">
            <div>
              ...
              <p className="mt-1 text-sm text-gray-500">
                Every earned or adjusted point record will appear here.
              </p>
            </div>
          </div>
