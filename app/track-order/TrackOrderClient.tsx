...
const getOrderPaymentStatus = (order: Order) => {
  ...
  if (method === "UPI QR Payment" || method === "Bank Transfer") {
              ...
              <div className="grid gap-6">
                <div className="rounded-2xl bg-white p-6 shadow-sm">
                  <div className="flex flex-wrap items-start justify-between gap-4">
                    ...
                    <div className="text-left sm:text-right">
                      ...
                      <p className="mt-3 text-sm font-semibold text-gray-600">
                        Payment: {getOrderPaymentStatus(trackedOrder)}
                      </p>
                    </div>
                  </div>
                  ...
                  <div className="mt-6 grid gap-4 md:grid-cols-5">
                    ...
                    <div className="rounded-xl bg-gray-50 p-4">
                      ...
                      <p className="mt-1 font-black text-gray-900">
                        {getOrderPaymentMethod(trackedOrder)}
                      </p>
                    </div>
                  </div>
                </div>
                  ...
                  <div className="rounded-2xl border border-orange-200 bg-orange-50 p-6 shadow-sm">
                    ...
                    <div className="mt-4 grid gap-3 text-sm">
                      <p>
                        ...
                        {trackedOrder.refundRequest.id}
                      </p>
                      <p>
                        <span className="font-bold">Type:</span>{" "}
                        {trackedOrder.refundRequest.type}
                      </p>
                      <p>
                        <span className="font-bold">Status:</span>{" "}
                        <span className="font-black text-orange-700">
                          {trackedOrder.refundRequest.status}
                        </span>
                      </p>
                      <p>
                        <span className="font-bold">Reason:</span>{" "}
                        {trackedOrder.refundRequest.reason}
                      </p>

                      {trackedOrder.refundRequest.adminNote && (
                        <p>
                    ...
                    <Link
                      ...
                      className="mt-5 inline-block rounded bg-orange-600 px-5 py-3 text-sm font-bold text-white hover:bg-orange-700"
                    >
                      View Request
                    </Link>
                  </div>
                ...
                <div className="rounded-2xl bg-white p-6 shadow-sm">
                  ...
                  <div className="mt-5 flex flex-wrap gap-3">
                    <Link
                      href={`/invoice?orderId=${encodeURIComponent(trackedOrder.id)}`}
                    ...
                    {trackedOrder.status === "Delivered" && (
                      <Link
                        href={`/delivery-feedback?orderId=${encodeURIComponent(trackedOrder.id)}`}
                    ...
                    {trackedOrder.status === "Delivered" && (
                      <Link
                        ...
                        className="rounded border border-orange-600 px-5 py-3 text-sm font-bold text-orange-600 hover:bg-orange-600 hover:text-white"
                      >
                        Return / Refund
                      </Link>
                    )}
